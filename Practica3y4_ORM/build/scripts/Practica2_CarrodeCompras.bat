...
set CLASSPATH=%APP_HOME%\lib\Practica2_CarrodeCompras-1.0-SNAPSHOT.jar;%APP_HOME%\lib\javalin-4.6.0.jar;%APP_HOME%\lib\slf4j-simple-1.7.36.jar;%APP_HOME%\lib\thymeleaf-3.0.15.RELEASE.jar;%APP_HOME%\lib\velocity-engine-core-2.3.jar;%APP_HOME%\lib\h2-2.1.214.jar;%APP_HOME%\lib\jasypt-1.9.3.jar;%APP_HOME%\lib\hibernate-core-6.1.0.Final.jar;%APP_HOME%\lib\postgresql-42.3.6.jar;%APP_HOME%\lib\slf4j-api-1.7.36.jar;%APP_HOME%\lib\jetty-webapp-9.4.46.v20220331.jar;%APP_HOME%\lib\websocket-server-9.4.46.v20220331.jar;%APP_HOME%\lib\jetty-servlet-9.4.46.v20220331.jar;%APP_HOME%\lib\jetty-security-9.4.46.v20220331.jar;%APP_HOME%\lib\jetty-server-9.4.46.v20220331.jar;%APP_HOME%\lib\kotlin-stdlib-jdk8-1.5.32.jar;%APP_HOME%\lib\ognl-3.1.26.jar;%APP_HOME%\lib\attoparser-2.0.5.RELEASE.jar;%APP_HOME%\lib\unbescape-1.1.6.RELEASE.jar;%APP_HOME%\lib\commons-lang3-3.11.jar;%APP_HOME%\lib\jakarta.persistence-api-3.0.0.jar;%APP_HOME%\lib\jakarta.transaction-api-2.0.0.jar;%APP_HOME%\lib\jboss-logging-3.4.3.Final.jar;%APP_HOME%\lib\hibernate-commons-annotations-6.0.2.Final.jar;%APP_HOME%\lib\jandex-2.4.2.Final.jar;%APP_HOME%\lib\classmate-1.5.1.jar;%APP_HOME%\lib\byte-buddy-1.12.9.jar;%APP_HOME%\lib\jaxb-runtime-3.0.2.jar;%APP_HOME%\lib\jaxb-core-3.0.2.jar;%APP_HOME%\lib\jakarta.xml.bind-api-3.0.1.jar;%APP_HOME%\lib\jakarta.inject-api-2.0.0.jar;%APP_HOME%\lib\antlr4-runtime-4.10.jar;%APP_HOME%\lib\checker-qual-3.5.0.jar;%APP_HOME%\lib\websocket-servlet-9.4.46.v20220331.jar;%APP_HOME%\lib\javax.servlet-api-3.1.0.jar;%APP_HOME%\lib\websocket-client-9.4.46.v20220331.jar;%APP_HOME%\lib\jetty-client-9.4.46.v20220331.jar;%APP_HOME%\lib\jetty-http-9.4.46.v20220331.jar;%APP_HOME%\lib\websocket-common-9.4.46.v20220331.jar;%APP_HOME%\lib\jetty-io-9.4.46.v20220331.jar;%APP_HOME%\lib\jetty-xml-9.4.46.v20220331.jar;%APP_HOME%\lib\kotlin-stdlib-jdk7-1.5.32.jar;%APP_HOME%\lib\kotlin-stdlib-1.5.32.jar;%APP_HOME%\lib\javassist-3.20.0-GA.jar;%APP_HOME%\lib\jakarta.activation-2.0.1.jar;%APP_HOME%\lib\jetty-util-ajax-9.4.46.v20220331.jar;%APP_HOME%\lib\jetty-util-9.4.46.v20220331.jar;%APP_HOME%\lib\websocket-api-9.4.46.v20220331.jar;%APP_HOME%\lib\annotations-13.0.jar;%APP_HOME%\lib\kotlin-stdlib-common-1.5.32.jar;%APP_HOME%\lib\txw2-3.0.2.jar;%APP_HOME%\lib\istack-commons-runtime-4.0.1.jar
